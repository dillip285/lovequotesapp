...
const QuoteGenerator = () => {
  ...
  return (
      ...
      <p className="disclaimer">
        Love your wife! but her love language is words of affirmation, and you're not sure where to start? Use this generator to set  mood and come up with the right sentence.
        <strong className="warning" > Don't be lazy enough to tell direct text to your wife.</strong>
      </p>
